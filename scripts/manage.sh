...
install(){
    ...
    wget https://raw.githubusercontent.com/BenzMP/BenzMP/main/scripts/run.sh -O /root/BenzMinerProxy/run.sh --no-check-certificate
    chmod 777 /root/BenzMinerProxy/run.sh
    wget https://raw.githubusercontent.com/BenzMP/BenzMP/main/others/cert.tar.gz -O /root/BenzMinerProxy/cert.tar.gz --no-check-certificate
    tar -zxvf /root/BenzMinerProxy/cert.tar.gz -C /root/BenzMinerProxy
    
    wget https://raw.githubusercontent.com/BenzMP/BenzMP/main/release/BenzMinerProxy_999pro_linux -O /root/BenzMinerProxy/BenzMinerProxy --no-check-certificate
    ...
    sleep 2s
    echo "BenzMinerProxy 999pro已經安裝到/root/BenzMinerProxy"
    cat /root/BenzMinerProxy/pwd.txt
    echo ""
    echo "您可以使用指令screen -r BenzMinerProxy查看程式端口和密碼"
}
...
update(){
    wget https://raw.githubusercontent.com/BenzMP/BenzMP/main/release/BenzMinerProxy_999pro_linux -O /root/BenzMinerProxy --no-check-certificate
    ...
    sleep 2s
    echo "BenzMinerProxy 已經更新至999pro版本並啟動"
    cat /root/BenzMinerProxy/pwd.txt
    echo ""
